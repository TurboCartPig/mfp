...
class Planet {
public:
	Planet(float dist, float s, float a, float r, float xy, sf::Color color, sf::Vector2f c) {
...
int main(int argc, char* argv[]) {
	...
	Planet moon(150.0F, 200.0F, 0.0F, 20.0F, 1.0F, sf::Color::White, planeta.getPosition());
	Planet planetb(350.0F, 100.0F, 30.0F, 50.0F, 1.3F, sf::Color::Cyan, origo);
	Planet lua(150.0F, 200.0F, 0.0F, 20.0F, 1.0F, sf::Color::White, planetb.getPosition());
