...
int main() {
	...
	// so you avoid having high floating numbers and skipping a bunch of
	// numbers? Or start with 10000 * 100000 / -2 and go up to 10000 * 100000 /
	// 2, and get more numbers inbetween?
